            ...
            <SectionBody>
                <div className=" flex flex-col lg:flex-row justify-center items-center">
                    <div className="flex justify-center items-center">
                        <div className="relative w-[300px] h-[300px] rounded-3xl xl:w-[400px] xl:h-[400px] lg:rounded-full overflow-hidden shadow-lg">
                            <Image
                                src="/foto-perfil.jpg"
                                alt="Foto de perfil"
                                fill
                    ...
                    <p className="flex w-[100%] mt-[3rem] items-center justify-center text-lg lg:pl-20 lg:text-xl xl:text-xl text-justify font-sans">
